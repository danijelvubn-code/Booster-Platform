...
import { i as Route$8, m as models, g as getOverallModelScore, c as cn, a as Tooltip, b as TooltipTrigger, d as TooltipContent, h as formatEurPer1MForDisplay } from "./router-D-bBPX7r.mjs";
import { H as HOSTING_PROVIDER_BOOSTER } from "./model-hosting-providers-DHMjetE5.mjs";
import { g as getCatalogModalities, a as getCatalogApiCapabilities, b as getCatalogFeatures, c as getCapabilityCategoryScore, d as getCapabilitySubcategoryScore, e as getLicenseCategory, f as getCatalogDataTypes, h as getCatalogAccessFormats, i as getCatalogQuantizations, j as getModelOriginLabel, k as getModelBaseFamily, l as getParamBillions, m as getCapabilitySubcategoryNames, n as capabilitySubcategoryViableAtMinScore } from "./catalog-filter-meta-CTmpK1nn.mjs";
import { L as Link } from "../_libs/tanstack__react-router.mjs";
import { M as ModelCosmosCard } from "./ModelCosmosCard-D2PNIqK-.mjs";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, g as getPaginationWindow, e as SelectedFilterChips } from "./SelectedFilterChips-CGzwX_Oc.mjs";
import { B as Badge, b as badgeVariants } from "./badge-bkIpVg5q.mjs";
import { B as Button } from "./button-DCHwUidX.mjs";
import { C as Checkbox$1, a as CheckboxIndicator } from "../_libs/radix-ui__react-checkbox.mjs";
import { c as cva } from "../_libs/class-variance-authority.mjs";
import { P as Popover, a as PopoverTrigger, b as PopoverContent, c as PopoverMenuFooter } from "./popover-BAmoT0uq.mjs";
...
import { a as InputField, I as Input, L as Label } from "./input-CMl7xTE1.mjs";
import { S as Separator } from "./separator-C2cSZ8Bf.mjs";
...
import "./model-provider-logos-CIQpQjcf.mjs";
import "./card-2jMQWmXc.mjs";
import { r as Search, s as SlidersHorizontal, C as ChevronDown, o as Check, t as Minus, X, I as Info, u as Type, V as Video, v as Mic, w as Image } from "../_libs/lucide-react.mjs";
...
import "./model-lifecycle-DdncnGhw.mjs";
...
const BOOSTER_POWERED_PROVIDER = HOSTING_PROVIDER_BOOSTER;
...
const defaultSort = "capability_desc";
...
function sortModels(list, sort, catalogOrder) {
  const out = [...list];
  out.sort((a, b) => compareModelsForSort(a, b, sort));
  return out;
}
function pinDeprecatedModelsToFirstPage(sorted, pageSize) {
...
const FILTER_TOOLBAR_ROW_CLASS = "flex min-w-0 items-stretch gap-2 [&>button]:min-w-0 [&>button]:w-full [&>button]:flex-1";
function filterToolbarButtonClassName(active) {
  return cn(
    ...
    active && "border-primary/60 bg-white hover:border-primary hover:bg-white"
  );
}
function filterToolbarActionButtonClassName(active) {
  return cn(
...
const FilterTriggerButton = reactExports.forwardRef(function FilterTriggerButton2({ active, badgeCount, className, children, ...props }, ref) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Button,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex min-w-0 items-center gap-1 truncate", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children }),
          badgeCount != null && badgeCount > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "shrink-0 px-1.5", children: badgeCount }) : null
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ChevronDown,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FilterPopoverScrollBody, { scrollHeightClassName: "h-64", children: featureOptions.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(FilterCheckboxRow, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex flex-1 items-center gap-1 text-body-sm", children: [
          ...
          f === "Reasoning" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "left", className: "max-w-xs", children: "Supports reasoning-oriented behavior or reasoning mode where available." })
          ] }) : null
        ] })
      ] }, f)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function ModelCosmosFilterBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("flex min-w-0 flex-col gap-3", className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: FILTER_TOOLBAR_ROW_CLASS, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ProviderFilter,
        {
          catalog,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SlidersHorizontal, { className: "h-icon-16 w-icon-16 shrink-0", "aria-hidden": true }),
            "More filters",
            moreFiltersActiveCount > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "shrink-0 px-1.5", children: moreFiltersActiveCount }) : null
          ]
        }
      )
    ] }),
...
function ModelCosmosPage() {
  ...
  const sortedFiltered = reactExports.useMemo(() => pinDeprecatedModelsToFirstPage(sortModels(filtered, sort), COSMOS_PAGE_SIZE), [filtered, sort]);
  reactExports.useEffect(() => {
    setPage(1);
  }, [search, filters, sort]);
