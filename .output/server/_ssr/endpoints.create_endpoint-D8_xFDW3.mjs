...
import { S as Sheet, A as AppSideSheetContent } from "./AppSideSheet-BE1K7bXY.mjs";
import { M as ModelCosmosCard } from "./ModelCosmosCard-D1kxlaS4.mjs";
import { B as Button } from "./button-DnRCyT-6.mjs";
import { I as Input } from "./input-BOqlbEZE.mjs";
...
import { t as Route$5, m as models, u as getProviderOptions, h as getOverallModelScore, v as getModelModalityLabel, a as Tooltip, b as TooltipTrigger, d as TooltipContent, c as cn, w as overallScoreTextClass, e as endpoints, s as deployments, x as getModelParameterCount } from "./router-D-lR6Urn.mjs";
import { W as WizardStepper, B as BasicSetupStep, R as ReviewStep } from "./WizardStepper-BSUqLN4Y.mjs";
import { M as ModelLifecycleAlert } from "./ModelLifecycleAlert-DY5Q-wdD.mjs";
import { P as PageHeader } from "./PageHeader-Bqj10aqc.mjs";
...
import { C as Card } from "./card-TFsw_QGS.mjs";
import "../_libs/sonner.mjs";
import { q as ArrowLeft, A as ArrowRight, H as Activity, r as Rocket, I as Info, s as Search } from "../_libs/lucide-react.mjs";
...
import "./model-hosting-providers-yb-ayFcP.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-6xl flex h-[calc(100vh-3.5rem)] min-h-0 flex-col gap-4 overflow-hidden py-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid min-h-0 flex-1 basis-0 grid-cols-1 gap-4 overflow-hidden lg:grid-cols-endpoint-deploy-wizard", children: [
        selectedModel ? /* @__PURE__ */ jsxRuntimeExports.jsx(ModelSummarySidebar, { model: selectedModel, providerCount, inputCostPer1M: summaryInputCostPer1M, outputCostPer1M: summaryOutputCostPer1M }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ModelSummarySidebarEmpty, { onSelectModel: openModelPicker }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "min-h-0 h-full min-w-0 lg:col-span-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "flex h-full flex-col overflow-hidden p-0", children: [
          ...
          step === 1 ? selectedModel && selectedProvider ? /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewStep, { endpointName, useCase, selectedModel, selectedProvider, setStep }) : null : null,
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 border-t border-border p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
            ...
            step < 1 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: goNext, disabled: !canProceed || isDeploying, children: [
              "Next ",
