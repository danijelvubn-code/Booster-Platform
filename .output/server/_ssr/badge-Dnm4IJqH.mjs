...
function Badge({
  ...
  const content = /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    leadingIcon,
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex min-w-0 items-center gap-1", children }),
    trailingIcon
  ] });
  if (isDismissible || onClick) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        type: "button",
        tabIndex: isDismissible ? void 0 : 0,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: baseClassName, ...props, children: content });
}
export {
  Badge as B,
  badgeVariants as b
