...
import { ar as Table2, as as ChartLine, a3 as FileText, $ as Clock, at as Gauge, H as Activity, Z as Zap, K as Leaf, au as MessageCircleQuestionMark, av as ScrollText } from "../_libs/lucide-react.mjs";
...
function getModelPerformanceBenchmark(model) {
  return MODEL_PERFORMANCE_BENCHMARKS[model.id] ?? (model.hosting === "Booster Powered" ? QWEN35_27B_PERFORMANCE_BENCHMARK : null);
}
export {
