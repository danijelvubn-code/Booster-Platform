...
import { C as CardGrid } from "./CardGrid-DKsGLJ4z.mjs";
import { L as Link } from "../_libs/tanstack__react-router.mjs";
import { B as Badge } from "./badge-Dnm4IJqH.mjs";
import { B as Button } from "./button-DnRCyT-6.mjs";
import { C as Card, a as CardContent } from "./card-TFsw_QGS.mjs";
import { D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, c as DropdownMenuItem, d as DropdownMenuSeparator } from "./dropdown-menu-BcVMMg8w.mjs";
...
import { r as resolveEndpointStatus, g as getEndpointStatusDotClassName, a as getEndpointStatusLabel } from "./endpoint-status-DWtSdrJZ.mjs";
import { e as endpoints, c as cn } from "./router-D-lR6Urn.mjs";
import { P as PageContainer } from "./PageContainer-B9Tci9E7.mjs";
import { P as PageHeader } from "./PageHeader-Bqj10aqc.mjs";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription } from "./dialog-JbPCLLnM.mjs";
import { B as BookOpen, N as Network, h as Earth, i as Box, j as ShieldCheck, k as BadgeCheck, A as ArrowRight, l as Link2, m as Ellipsis, T as Trash2, R as RefreshCw } from "../_libs/lucide-react.mjs";
...
const endpointCardSurfaceClass = "border border-transparent shadow-sm hover:border-primary/40 hover:shadow-md transition duration-200 ease-standard";
...
function EndpointStatusIcon({
  endpoint,
  className
}) {
  const status = resolveEndpointStatus(endpoint);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(IconBox, { size: "xlg", shape: "square", className: "bg-primary/4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "text-primary", "aria-hidden": true }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 right-0 rounded-full bg-card p-1 ring-2 ring-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: cn(
              "block size-[10px] rounded-full",
              getEndpointStatusDotClassName(status)
            ),
            "aria-hidden": true
          }
        ) })
        ...
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(EndpointStatusIcon, { endpoint }),
...
function endpointListSortKey(id) {
  const numeric = Number(id.replace(/^sp-/, ""));
  return Number.isFinite(numeric) ? numeric : 0;
}
function getOverviewEndpoints() {
  return [...endpoints].filter((endpoint) => endpoint.id !== "sp-default").sort((a, b) => endpointListSortKey(b.id) - endpointListSortKey(a.id));
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PageContainer, { className: "pt-6 pb-6", gap: "gap-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "flex flex-col gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { titleSize: "overview", breakAt: "md", introClassName: "max-w-3xl", title: "Endpoints", description: "View and manage the stable API endpoints your applications use for model inference." }),
