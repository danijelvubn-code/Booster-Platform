...
import { W as WizardStepper, B as BasicSetupStep, R as ReviewStep } from "./WizardStepper-CsMa1s7H.mjs";
import { M as ModelLifecycleAlert } from "./ModelLifecycleAlert-D3hnjTWq.mjs";
...
import { k as Route$6, m as models, g as getOverallModelScore, l as getModelParameterSizeLabel, n as modelHasVisionCapability, o as formatContextWindowShort, e as endpoints, p as deployments } from "./router-D-bBPX7r.mjs";
import { c as canCreateInferenceEndpoint, g as getModelStatusBadgeVariant } from "./model-lifecycle-DdncnGhw.mjs";
import "./input-CMl7xTE1.mjs";
import "./textarea-DLNnNal7.mjs";
import "../_libs/sonner.mjs";
import { q as ArrowLeft, A as ArrowRight, D as Activity, R as Rocket } from "../_libs/lucide-react.mjs";
...
function RouteComponent() {
  ...
  const handleDeploy = () => {
    if (!canProceed || isDeploying || !canCreateInferenceEndpoint(selectedModel)) return;
    setIsDeploying(true);
    window.setTimeout(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-6xl flex h-full min-h-0 flex-1 flex-col gap-4 overflow-hidden py-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ModelLifecycleAlert, { model: selectedModel, className: "shrink-0" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid min-h-0 flex-1 grid-cols-1 gap-4 lg:grid-cols-endpoint-deploy-wizard", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "h-full min-w-0 lg:col-span-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "flex h-full flex-col overflow-hidden p-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "divide-y divide-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: getModelStatusBadgeVariant(selectedModel.status), size: "20", children: selectedModel.status })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "min-h-0 h-full min-w-0 lg:col-span-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "flex h-full flex-col overflow-hidden p-0", children: [
        ...
        step === 1 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewStep, { endpointName, useCase, selectedModel, inputCostPer1M: selectedProvider.inputPer1M, outputCostPer1M: selectedProvider.outputPer1M, setStep }) : null,
