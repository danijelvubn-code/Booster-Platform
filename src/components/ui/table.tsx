...
const TableCellStack = React.forwardRef<
	HTMLDivElement,
...
const TableCellTitle = React.forwardRef<
	HTMLSpanElement,
...
const TableCellDescription = React.forwardRef<
	HTMLSpanElement,
	React.HTMLAttributes<HTMLSpanElement>
>(({ className, ...props }, ref) => {
	const size = useTableSize()
...
function TableCellWithDescription({
	title,
	description,
	className,
}: TableCellWithDescriptionProps) {
	return (
...
type TableCellWithAvatarNameProps = Omit<
	React.HTMLAttributes<HTMLDivElement>,
	'title'
> & {
...
const TableCellWithAvatarName = React.forwardRef<
	HTMLDivElement,
	TableCellWithAvatarNameProps
