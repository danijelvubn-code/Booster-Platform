...
import { B as BoosterLogo } from "./BoosterLogo-C0nzsfiF.mjs";
import { B as Button } from "./button-DnRCyT-6.mjs";
import { T as Toaster, u as useTheme } from "./sonner-C3D2Kk0w.mjs";
import { D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, c as DropdownMenuItem } from "./dropdown-menu-BcVMMg8w.mjs";
import { c as cn, T as TooltipProvider, a as Tooltip, b as TooltipTrigger, d as TooltipContent } from "./router-D-lR6Urn.mjs";
import { u as useAuth } from "./use-auth-DmZ_d5aG.mjs";
...
function AppLayout() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mvp-shell flex h-dvh flex-col overflow-hidden bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "relative flex min-h-0 flex-1 flex-col overflow-hidden pt-[57px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
  ] });
}
