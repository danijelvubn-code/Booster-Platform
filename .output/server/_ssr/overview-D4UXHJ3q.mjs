...
import { T as TokenUsageSection, C as CardGrid } from "./TokenUsageSection-DhlU4_eG.mjs";
...
import { D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, c as DropdownMenuItem, d as DropdownMenuSeparator } from "./dropdown-menu-BkOY0CfW.mjs";
...
import { e as endpoints, c as cn } from "./router-D-bBPX7r.mjs";
import { P as PageContainer } from "./PageContainer-CazM7ltn.mjs";
import { P as PageHeader } from "./PageHeader-Be83zSdl.mjs";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription } from "./dialog-RUReqGY-.mjs";
import { u as useAuth } from "./use-auth-ChI1tgha.mjs";
import "./icon-box-Bmy30hjT.mjs";
import { B as BookOpen, N as Network, h as Earth, i as Box, j as ShieldCheck, k as BadgeCheck, A as ArrowRight, l as Link2, m as Ellipsis, T as Trash2 } from "../_libs/lucide-react.mjs";
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 items-start gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 flex-1 flex-col gap-0.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate text-body-strong text-foreground", children: endpoint.name }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 items-center gap-1.5 text-body-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Box,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: cn(
                    "min-w-0 truncate",
                    endpoint.defaultDeployment ? "text-foreground/75" : "text-muted-foreground"
                  ),
