...
import { C as Card, b as CardHeader, c as CardTitle, a as CardContent } from "./card-TFsw_QGS.mjs";
import { L as Label } from "./input-BOqlbEZE.mjs";
import { t as toast } from "./sonner-C3D2Kk0w.mjs";
import { R as Root, T as Thumb } from "../_libs/radix-ui__react-switch.mjs";
import { c as cva } from "../_libs/class-variance-authority.mjs";
import { O as Route, e as endpoints, m as models, c as cn, s as deployments } from "./router-D-lR6Urn.mjs";
...
import { c as canCreateInferenceEndpoint } from "./model-lifecycle-DdncnGhw.mjs";
...
function RouteComponent() {
  ...
  const handleDeploy = () => {
    if (!selectedModel || !endpoint || !canCreateInferenceEndpoint(selectedModel)) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageContainer, { gap: "space-y-6", className: "py-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ModelLifecycleAlert, { model: selectedModel }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleDeploy, size: "lg", disabled: !deployAllowed, children: [
      "Add to Endpoint ",
