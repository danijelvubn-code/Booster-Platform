  ...
  "inline-flex select-none items-center justify-center gap-1 rounded-md border px-2 transition-colors ease-standard",
  {
    ...
    compoundVariants: [
      ...
      },
      {
        appearance: "pill",
        variant: "info",
        className: "border-transparent bg-info text-info-foreground hover:bg-info/90"
      },
      {
        appearance: "pill",
        variant: "outline",
      ...
      },
      {
        appearance: "ghost",
        variant: "default",
        className: "bg-primary/[0.04] border-primary/[0.15] text-primary hover:bg-primary/[0.07] hover:border-primary/[0.25]"
      },
      {
        appearance: "ghost",
        variant: "secondary",
        className: "border-secondary/30 bg-secondary/10 text-secondary-foreground hover:border-secondary/40 hover:bg-secondary/20"
      },
      {
        appearance: "ghost",
        variant: "destructive",
        className: "border-destructive/20 bg-destructive/5 text-destructive hover:border-destructive/30 hover:bg-destructive/10"
      },
      {
        appearance: "ghost",
        variant: "success",
        className: "border-success/20 bg-success/5 text-success hover:border-success/30 hover:bg-success/10"
      },
      {
        appearance: "ghost",
        variant: "warning",
        className: "border-warning/20 bg-warning/5 text-warning hover:border-warning/30 hover:bg-warning/10"
      },
      {
        appearance: "ghost",
        variant: "info",
        className: "border-info/20 bg-info/5 text-info hover:border-info/30 hover:bg-info/10"
      },
      {
        appearance: "ghost",
        variant: "outline",
      ...
      },
      {
        appearance: "ghost",
        variant: "muted",
        className: "border-border bg-muted/50 text-muted-foreground hover:border-border hover:bg-muted"
      }
    ],
    defaultVariants: {
      variant: "default",
...
function Badge({
  ...
  const baseClassName = cn(
    ...
    isDismissible && "cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
    className
  );
...
function getParamSizeLabel(name) {
...
function formatEurPerTokenFromPer1M(eurPer1M) {
  const per = eurPer1M / 1e6;
...
export {
  Badge as B,
  modelHasVisionCapability as a,
  getMathScore as b,
  getReasoningScore as c,
  getCodingScore as d,
  endpoints as e,
  getParamSizeLabel as f,
  getOverallModelScore as g,
  formatContextWindowShort as h,
  deployments as i,
  getProviderOptions as j,
  getModelModalityLabel as k,
  getModelCatalogBadge as l,
  models as m,
  formatEurPerTokenFromPer1M as n,
  overallScoreTextClass as o,
  getModelSubline as p,
  formatContextLength as q,
  getSustainabilityGradeStyles as r,
  optimizationObjectives as s,
  apiKeys as t,
  useCaseCategories as u
};
