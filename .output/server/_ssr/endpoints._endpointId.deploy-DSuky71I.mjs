...
import { e as endpoints, m as models, B as Badge, i as deployments } from "./mockData-CaVm0p_Q.mjs";
...
import { L as Label } from "./input-BIbIoEB2.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { R as Root, T as Thumb } from "../_libs/radix-ui__react-switch.mjs";
import { c as cva } from "../_libs/class-variance-authority.mjs";
import { n as Route, c as cn } from "./router-D2WQTUn2.mjs";
import { n as ArrowLeft, q as Check } from "../_libs/lucide-react.mjs";
...
function RouteComponent() {
  ...
  if (!endpoint) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container py-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground", children: "Endpoint not found." })
    ] });
  }
  if (!model) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container py-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground", children: "No model selected. Please select a model from the catalog first." }),
