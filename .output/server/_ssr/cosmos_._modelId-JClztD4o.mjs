...
import { S as Sheet, a as SheetTrigger, A as AppSideSheetContent } from "./AppSideSheet-B3GceMgW.mjs";
import { A as Accordion, a as AccordionItem, b as AccordionTrigger, c as AccordionContent } from "./accordion-CmkzRKD2.mjs";
import { g as getModelProviderLogoSrc, A as Avatar, b as AvatarImage, c as AvatarFallback } from "./model-provider-logos-DIoDvw6k.mjs";
import { B as Badge } from "./badge-TVJ2MtYX.mjs";
import { B as Button } from "./button-BoQ28Ykk.mjs";
import { I as IconBox } from "./icon-box-DorOhvmT.mjs";
import { P as Progress } from "./progress-BjZARylQ.mjs";
import { S as Separator } from "./separator-sUe_iKu6.mjs";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-CQL6aQHO.mjs";
import { G as Route$2, m as models, u as getProviderOptions, T as TooltipProvider, a as Tooltip, b as TooltipTrigger, d as TooltipContent, c as cn, h as getOverallModelScore, v as getModelModalityLabel, q as getParamSizeLabel } from "./router-dUByybLQ.mjs";
import { I as Info, a1 as Scale, a2 as Share2, P as Plus, a3 as FileText, g as CircleCheck, a4 as Cpu, a5 as CodeXml, a6 as Brain, a7 as FlaskConical, a8 as MessageSquare, a9 as MessageSquareMore, aa as MessageSquareDashed, ab as Braces, ac as ArrowUpNarrowWide, k as BadgeCheck, ad as ListTree, ae as FileVolume, af as BookAudio, ag as AudioWaveform, ah as Hammer, ai as Table$1, H as BrainCircuit, aj as CircleStop, ak as MemoryStick, al as Maximize, am as Binary, an as FileArchive, ao as Weight, ap as GitBranchPlus, i as Box, q as ArrowLeft, u as Type, V as Video, v as Mic, w as Image } from "../_libs/lucide-react.mjs";
...
const SECTION_IDS = ["overview", "capabilities", "modalities", "endpoints", "features", "specifications", "sources", "providers"];
const NAV = [{
  id: "overview",
  label: "Overview"
}, {
...
function CapabilityCategoryDetailBody({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: category.subcategogies.map((sub) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-md border border-border bg-card", children: [
    ...
    sub.benchmarks && sub.benchmarks.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { containerClassName: "overflow-x-auto overflow-y-hidden", children: [
...
function RouteComponent() {
  ...
  const providerRows = reactExports.useMemo(() => model ? getProviderOptions(model.id).filter((provider) => provider.id !== "model-provider-fallback") : [], [model]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { delayDuration: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: scrollRootRef, className: "min-h-0 flex-1 overflow-y-auto", onScroll: handleSectionScroll, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container space-y-6 py-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-10 rounded-lg", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 flex-1 flex-col gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 flex-col gap-8 overflow-x-clip rounded-lg border border-border bg-card shadow-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: assignRef("capabilities"), "data-section": "capabilities", id: "model-detail-capabilities", className: "flex min-w-0 gap-16 px-6 max-lg:flex-col max-lg:gap-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 flex-1 flex-col gap-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(AppSideSheetContent, { title: "Score breakdown", description: "Capability score breakdown by category and sub-scores for this model.", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: assignRef("sources"), "data-section": "sources", id: "model-detail-sources", className: "flex min-w-0 gap-16 rounded-lg border border-border bg-card px-6 py-6 shadow-sm max-lg:flex-col max-lg:gap-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: assignRef("providers"), "data-section": "providers", id: "model-detail-providers", className: "mb-[30vh] flex min-w-0 flex-col gap-4 rounded-lg border border-border bg-card px-6 py-6 shadow-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { children: "Providers" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded-lg border border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: providerRows.map((provider) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "h-14 hover:bg-muted/50", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right text-body-sm text-foreground", children: formatEurPer1M(provider.inputPer1M) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right text-body-sm text-foreground", children: formatEurPer1M(provider.outputPer1M) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "success", appearance: "ghost", size: "24", className: "font-normal", leadingIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { "aria-hidden": true }), children: provider.certs.join(", ") }) })
            ] }, provider.id)) })
          ] }) }) })
        ] })
      ] })
