...
import { I as Input, b as InputRoot, c as InputSegment, d as InputControl, e as InputSuffixAddon } from "./input-CMl7xTE1.mjs";
...
import { O as Route$1, e as endpoints, c as cn, p as deployments, C as apiKeys } from "./router-D-bBPX7r.mjs";
...
import { K as Settings, aw as Key, j as ShieldCheck, ax as Users, ay as Bell, az as CreditCard, o as Check, J as Copy, a0 as ExternalLink, P as Plus, X } from "../_libs/lucide-react.mjs";
...
function GeneralSettingsPreview({
  ...
  const hasUnsavedChanges = nameDraft.trim() !== savedEndpointName.trim() || descriptionDraft.trim() !== savedDescription.trim();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "overflow-hidden border-0 shadow-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "endpoint-description", className: "text-body-sm-strong", children: "Use Case Description" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { id: "endpoint-description", value: descriptionDraft, onChange: (e) => onDescriptionChange(e.target.value), placeholder: "Describe your use case in a few sentences. For example: We need to process insurance claim documents and extract policy numbers, dates, and damage descriptions.", rows: 5 })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", onClick: onSave, disabled: !hasUnsavedChanges, children: "Save Changes" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 rounded-b-lg border border-destructive/30 bg-destructive/4 p-6", children: [
...
function RouteComponent() {
  ...
  const [descriptionDraft, setDescriptionDraft] = reactExports.useState(endpoint?.description ?? "");
  const [savedDescription, setSavedDescription] = reactExports.useState(endpoint?.description ?? "");
  reactExports.useEffect(() => {
    if (!endpoint) return;
  ...
  const handleSaveGeneral = () => {
    ...
    endpoint.description = trimmedDescription || void 0;
    ...
    toast.success("Settings saved", {
      description: nameChanged && descriptionChanged ? "Endpoint name and description have been updated." : nameChanged ? "Endpoint name has been updated." : "Use case description has been updated."
    });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageContainer, { gap: "space-y-8", className: "max-w-6xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-8 lg:flex-row lg:items-start", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1 space-y-6", children: [
        activeSection === "general" ? /* @__PURE__ */ jsxRuntimeExports.jsx(GeneralSettingsPreview, { endpoint, nameDraft, savedEndpointName, onNameChange: setNameDraft, descriptionDraft, savedDescription, onDescriptionChange: setDescriptionDraft, endpointUrl: endpoint.endpoint, onSave: handleSaveGeneral, onAfterEndpointDeleted: () => navigate({
          to: "/app/overview",
          replace: true
        }) }) : null,
        activeSection === "api-keys" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "overflow-hidden border-0 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ApiKeysPanel, { spaceName: endpoint.name }) }) }) : null
      ] })
    ] })
  ] });
}
