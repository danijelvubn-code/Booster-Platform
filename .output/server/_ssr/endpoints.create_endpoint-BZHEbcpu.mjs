...
import { M as ModelLifecycleAlert, A as Alert, a as AlertTitle, b as AlertDescription } from "./ModelLifecycleAlert-D3hnjTWq.mjs";
...
import { S as Sheet, A as AppSideSheetContent } from "./AppSideSheet-BDD1rKsl.mjs";
import { M as ModelCosmosCard } from "./ModelCosmosCard-D2PNIqK-.mjs";
...
import { q as Route$5, m as models, r as getProviderOptions, g as getOverallModelScore, s as getModelModalityLabel, a as Tooltip, b as TooltipTrigger, d as TooltipContent, c as cn, t as overallScoreTextClass, e as endpoints, p as deployments } from "./router-D-bBPX7r.mjs";
import { W as WizardStepper, B as BasicSetupStep, R as ReviewStep, f as formatEndpointParameters, a as formatEndpointMinMemory, b as formatEndpointContextWindow, c as formatEndpointEurPer1M } from "./WizardStepper-CsMa1s7H.mjs";
...
import "./textarea-DLNnNal7.mjs";
import { q as ArrowLeft, A as ArrowRight, R as Rocket, I as Info, F as CircleAlert, r as Search } from "../_libs/lucide-react.mjs";
...
import "./EnergyScorePill-BGOUx-wU.mjs";
import "./model-hosting-providers-DHMjetE5.mjs";
...
function getRandomDeployDurationMs() {
  return 5e3 + Math.random() * 5e3;
}
function EndpointDeployingScreen({
  endpointName,
  modelName,
  durationMs,
  shouldFail = false,
  ...
  const hasSignaledFailureRef = reactExports.useRef(false);
  ...
  const activeMessage = phase === "failed" ? failureDetails?.failedStep ?? DEPLOY_MESSAGES[messageIndex] : DEPLOY_MESSAGES[messageIndex];
  if (phase === "failed") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex min-h-0 flex-1 flex-col items-center justify-center gap-8 p-8 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex max-w-lg flex-col items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          IconBox,
          {
            size: "xxxlg",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "text-destructive", "aria-hidden": true })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-h3 text-foreground", children: "Deployment failed" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-body-sm text-muted-foreground", children: [
            "We couldn't finish setting up",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: endpointName }),
            " ",
            "with",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: modelName })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-md space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 text-caption text-destructive", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "min-w-0 truncate text-left", children: activeMessage }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "shrink-0 tabular-nums", children: [
            Math.round(progress),
            "%"
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Alert, { variant: "destructive", className: "max-w-lg text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertTitle, { children: failureDetails?.title ?? "Deployment failed" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDescription, { children: failureDetails?.description ?? "Something went wrong while provisioning your endpoint. Please try again or choose a different model." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: onRetry, children: "Try again" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: onBackToReview, children: "Back to review" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: onChooseModel, children: "Choose another model" })
      ] })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex min-h-0 flex-1 flex-col items-center justify-center gap-8 p-8 text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex h-20 w-20 items-center justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 animate-ping rounded-full bg-primary/15" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-2 animate-pulse rounded-full bg-primary/10" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          IconBox,
          {
            size: "xxxlg",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Rocket, { className: "text-primary", "aria-hidden": true })
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-h3 text-foreground", children: "Deploying endpoint" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "max-w-sm text-body-sm text-muted-foreground", children: [
          "Setting up",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: endpointName }),
          " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-md space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 text-caption text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "min-w-0 truncate text-left", children: activeMessage }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "shrink-0 tabular-nums", children: [
          Math.round(progress),
          "%"
...
function EndpointModelSelectSheet({
  ...
  const pendingModel = pendingId ? models2.find((model) => model.id === pendingId) : null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    AppSideSheetContent,
    {
      ...
      footer: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
        pendingModel && !canCreateInferenceEndpoint(pendingModel) ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-body-sm text-muted-foreground", children: [
          pendingModel.name,
          " is deprecated and cannot be attached to a new inference endpoint. Choose an active model instead."
        ] }) : null,
              ...
              onClick: () => {
                ...
                if (!canCreateInferenceEndpoint(pendingModel)) {
                  toast.error("Deprecated model cannot be deployed", {
                    description: "Choose an active or sunsetting model for new inference endpoints."
                  });
                  return;
                }
                onConfirm(pendingId);
...
const DEPLOY_FAILURE_MODEL_IDS = /* @__PURE__ */ new Set(["m-14"]);
function shouldSimulateDeployFailure(model) {
  return DEPLOY_FAILURE_MODEL_IDS.has(model.id);
}
function getDeployFailureDetails(model) {
  if (model.id === "m-14") {
    return {
  ...
  return {
    ...
    description: "Something went wrong while provisioning your endpoint. Please try again or choose a different model.",
...
function ModelSummarySidebar({
  ...
  const licenseLabel = model.hosting === "Booster Hosted" ? "Commercial" : "Open Source";
  return /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "min-w-0 self-start lg:col-span-1 lg:flex lg:h-full lg:min-h-0 lg:flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "relative flex h-full min-h-0 flex-col overflow-hidden border-primary/30 p-0 lg:flex-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "aria-hidden": true, className: "pointer-events-none absolute inset-0 rounded-lg bg-gradient-to-bl from-primary/10 via-transparent to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative space-y-4 border-b border-border p-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: getModelStatusBadgeVariant(model.status), appearance: "pill", size: "24", children: model.status }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", appearance: "ghost", size: "24", children: model.hosting })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative divide-y divide-border", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ModelSummaryRow, { label: "Context Window", value: formatEndpointContextWindow(model) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ModelSummaryRow, { label: "Min. Memory", value: minMemoryLabel }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ModelSummaryRow, { label: "Input Tokens", value: formatEndpointEurPer1M(inputCostPer1M) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ModelSummaryRow, { label: "Output Tokens", value: formatEndpointEurPer1M(outputCostPer1M) })
    ] })
  ] }) });
}
function RouteComponent() {
  ...
  const [deployDurationMs, setDeployDurationMs] = reactExports.useState(null);
  const [deployAttempt, setDeployAttempt] = reactExports.useState(0);
  const pendingDeployRef = reactExports.useRef(null);
  ...
  const startDeploy = () => {
    if (!selectedModel || !selectedProvider || !canProceed || isDeploying || !canCreateInferenceEndpoint(selectedModel)) return;
    pendingDeployRef.current = {
      endpointId: `sp-${Date.now()}`
    };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-6xl flex h-[calc(100vh-3.5rem)] min-h-0 flex-col gap-4 overflow-hidden py-4", children: [
      ...
      selectedModel ? /* @__PURE__ */ jsxRuntimeExports.jsx(ModelLifecycleAlert, { model: selectedModel, className: "shrink-0" }) : null,
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid min-h-0 flex-1 basis-0 grid-cols-1 gap-4 overflow-hidden lg:grid-cols-endpoint-deploy-wizard", children: [
        selectedModel ? /* @__PURE__ */ jsxRuntimeExports.jsx(ModelSummarySidebar, { model: selectedModel, inputCostPer1M: summaryInputCostPer1M, outputCostPer1M: summaryOutputCostPer1M }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ModelSummarySidebarEmpty, { onSelectModel: openModelPicker }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "min-h-0 h-full min-w-0 lg:col-span-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "flex h-full flex-col overflow-hidden p-0", children: isDeploying && deployDurationMs != null && selectedModel ? /* @__PURE__ */ jsxRuntimeExports.jsx(EndpointDeployingScreen, { endpointName: endpointName.trim() || selectedModel.domain, modelName: selectedModel.name, durationMs: deployDurationMs, shouldFail: shouldSimulateDeployFailure(selectedModel), failureDetails: getDeployFailureDetails(selectedModel), onComplete: handleDeployComplete, onFailure: handleDeployFailure, onRetry: handleDeployRetry, onBackToReview: handleDeployDismiss, onChooseModel: handleDeployChooseModel }, deployAttempt) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          step === 1 ? selectedModel && selectedProvider ? /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewStep, { endpointName, useCase, selectedModel, inputCostPer1M: summaryInputCostPer1M, outputCostPer1M: summaryOutputCostPer1M, setStep }) : null : null,
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 border-t border-border p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", onClick: goBack, disabled: step === 0, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "mr-1 h-icon-16 w-icon-16" }),
              " Back"
            ] }),
            step < 1 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: goNext, disabled: !canProceed, children: [
              "Next ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "ml-1 h-icon-16 w-icon-16" })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleCreate, disabled: !canProceed, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(EndpointModelSelectSheet, { open: modelPickerOpen, onOpenChange: setModelPickerOpen, models, onConfirm: (modelId) => {
      navigate({
