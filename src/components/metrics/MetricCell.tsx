...
export type MetricCellProps = {
   ...
   * Future: add more presentation variants on this same surface (e.g. compact).
   */
  icon?: LucideIcon;
 ...
 */
export function MetricCell({ className, icon: Icon, label, children }: MetricCellProps) {
      ...
      <div className={cn(cellSurface, className)}>
        <div className="flex min-w-0 items-center justify-center gap-1">
          <div className="flex h-icon-20 w-icon-20 shrink-0 items-center justify-center rounded-md p-0.5">
            <Icon className="h-icon-16 w-icon-16 text-muted-foreground" aria-hidden />
          </div>
