...
>(({ className, children, ...props }, ref) => (
	...
	>
		...
		<SelectPrimitive.Icon asChild>
			<ChevronDown className="h-icon-16 w-icon-16 shrink-0 text-foreground/50" />
...
>(({ className, children, ...props }, ref) => (
	<SelectPrimitive.Item
		...
		{...props}
	>
		<span className="absolute left-2 flex h-icon-16 w-icon-16 items-center justify-center">
