...
import { g as modelHasVisionCapability, z as getModelCatalogBadge, l as formatEurPer1MForDisplay, c as cn, k as getCodingScore, j as getReasoningScore, i as getMathScore, h as getOverallModelScore, A as getModelSubline, a as Tooltip, b as TooltipTrigger, d as TooltipContent, B as formatContextLength, w as overallScoreTextClass, y as getSustainabilityGradeStyles } from "./router-D-lR6Urn.mjs";
import { a as getModelStatusDotClassName } from "./model-lifecycle-DdncnGhw.mjs";
import { g as getModelProviderLogoSrc, A as Avatar, b as AvatarImage, c as AvatarFallback, a as getProviderInitials } from "./model-provider-logos-D7FdBz9q.mjs";
...
import { E as Eye, J as BrainCircuit, K as Leaf, j as ShieldCheck } from "../_libs/lucide-react.mjs";
...
const cosmosCardSurfaceClass = "border border-transparent shadow-sm hover:border-primary/40 hover:shadow-md flex min-h-cosmos-card flex-col gap-3 overflow-hidden p-4 transition duration-200 ease-standard";
function BoosterHostedShield({ model }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { delayDuration: 300, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "top", children: "Booster Powered" })
  ] });
}
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 flex-1 flex-col gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "line-clamp-2 h-[42px] min-h-[42px] text-body-sm text-foreground/75", children: model.description })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 shrink-0", "aria-hidden": true }),
